...
_TEMPLATE_PARENT = os.path.dirname(os.path.dirname(os.path.dirname(__file__)))
if not os.path.exists(os.path.join(_TEMPLATE_PARENT, "scripts")) and os.path.exists(os.path.join(os.path.dirname(_TEMPLATE_PARENT), "scripts")):
    _TEMPLATE_PARENT = os.path.dirname(_TEMPLATE_PARENT)
