...
def rotation_6d_to_matrix(d6: Tensor) -> Tensor:
    ...
    WARNING: This function assumes the 6D representation is ROW-based (i.e. the first two rows 
    of the 3x3 rotation matrix, flattened). HY-Motion's diffusion pipeline and HumanML3D/SnapMoGen 
    often use COLUMN-based 6D representations (the first two columns). For column-based 6D, 
    use `rot6d_to_rotation_matrix` instead!
...
def matrix_to_rotation_6d(matrix: Tensor) -> Tensor:
    ...
    WARNING: This function creates a ROW-based 6D representation (the first two rows 
    flattened). HY-Motion's diffusion pipeline and HumanML3D/SnapMoGen often use 
    COLUMN-based 6D representations. For column-based 6D, use `rotation_matrix_to_rot6d`!
...
def rot6d_to_rotation_matrix(rot6d):
    ...
    WARNING: This function assumes the 6D representation is COLUMN-based (i.e. the first two columns 
    of the 3x3 rotation matrix, flattened). This is the standard format used in HY-Motion, HumanML3D, 
    and SnapMoGen. For row-based 6D representations, use `rotation_6d_to_matrix` instead!
...
def rotation_matrix_to_rot6d(rotation_matrix):
    ...
    WARNING: This function creates a COLUMN-based 6D representation (the first two columns 
    flattened). This is the standard format used in HY-Motion, HumanML3D, and SnapMoGen. 
    For row-based 6D representations, use `matrix_to_rotation_6d` instead!
